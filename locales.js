...
module.exports = {
    'en': {
        ...
        'TM1650fourDigitDisplay.description': '4-digit display module based on TM1650.',
        'TM1650fourDigitDisplay.name': '4-Digit Display',
        ...
        'motor.name': 'motor drive',
        'motor.description': 'Common motor drive.',
    ...
    'zh-cn': {
        ...
        'TM1650fourDigitDisplay.description': '基于 TM1650 的四位数码管。',
        'TM1650fourDigitDisplay.name': 'TM1650四位数码管',
        ...
        'motor.name': '电机驱动',
        'motor.description': '基于板载双线控制电机驱动。',
